                    ...
                    <div class="card shadow p-3">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h4 class="mb-0 ffw-bold">Rp. 10.000.000,-</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow p-3">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h4 class="mb-0 ffw-bold">100</h4>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            {{-- gatter buat atur box di boostrap ada g --}}
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="card shadow border-0">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <button class="btn btn-dark btn-sm-end">All</button>
                                @foreach ($categories as $category)
                                    <button class="btn btn-dark btn-sm-end">{{ $category->name ?? '' }}</button>
                                @endforeach
                                {{-- <button class="btn btn-dark btn-sm-end">Makanan</button> --}}
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow cart-box">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3 g-3">
